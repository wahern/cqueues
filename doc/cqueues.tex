...
be a condition variable instead of a function.  Similarly, the \method{:pollfd} field may be an integer descriptor. This permits user code to create \textit{ad hoc} pollable objects.
...
Tip: This routine is intended to be behave much like POSIX poll(2). Think of each object as a \texttt{struct pollfd} object.
...
l & line buffered output; output buffer is flushed up to and including the last LF after every write operation  \\
