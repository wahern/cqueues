...
Returns the previous and input and output buffer sizes, or throws an error if the buffers could not be reallocated.
...
Returns the previous and input and output sizes.
